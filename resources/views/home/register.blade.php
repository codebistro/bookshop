    ...
    <form name="loginform" id="loginform" action="{{ url('doregister') }}" method="post">
        ...
        <p>
            <label for="user_login">Username<br>
                <input type="text" name="name"  class="input" value="" size="20"></label>
        </p>
        <p>
            <label for="user_pass">Password<br>
                <input type="password" name="pw" class="input" value="" size="20"></label>
        </p>
        <p>
            <label for="user_pass">ConfirmPassword<br>
                <input type="password" name="pw1" class="input" value="" size="20"></label>
        </p>
        <p>
        ...
        <p>
            <label for="user_pass">Company Name<br>
                <input type="text" name="company" class="input" value="" size="20"></label>
        </p>
        <p>
            <label for="user_pass">Company Address<br>
                <input type="text" name="address" class="input" value="" size="20"></label>
        </p>
        <p>
            <label for="user_pass">Country<br>
                <input type="text" name="country" class="input" value="" size="20"></label>
        </p>
        <p>
            <label for="user_pass">Region<br>
                <input type="text" name="region" class="input" value="" size="20"></label>
        </p>
        <p class="submit">
